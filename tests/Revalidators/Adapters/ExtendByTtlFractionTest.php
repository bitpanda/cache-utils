...
use Bitpanda\CacheUtils\Revalidators\Adapters\ExtendByTtlFraction;
...
class ExtendByTtlFractionTest extends TestCase
{
    #[Test]
    public function it_extends_item_on_stale_revalidation(): void
    {
        ...
        $extendingRevalidator = new ExtendByTtlFraction($revalidator, 0.5);
        ...
        $this->assertSame(250, $result->extensionTtl);
    ...
    public function it_extends_items_on_stale_revalidation(): void
    {
        ...
        $this->assertSame(250, $result['key2']->extensionTtl);
